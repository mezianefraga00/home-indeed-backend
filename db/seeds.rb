...
owner2 = Owner.create(name: "Grover", phone_nbr: "432 3217832", login:"gro", password_digest: "nhetvascda", email: "gro@gmail.com" )
owner3 = Owner.create(name: "Nancy", phone_nbr: "132 3217832", login:"nan", password_digest: "vdfv", email: "nan@gmail.com" )
owner4 = Owner.create(name: "Asiyah", phone_nbr: "322 3217832", login:"asi", password_digest: "abcbgvd", email: "asi@gmail.com" )
owner5 = Owner.create(name: "Dane", phone_nbr: "132 3217832", login:"dan", password_digest: "abcdsasdad", email: "dan@gmail.com" )
owner6 = Owner.create(name: "Madeleine", phone_nbr: "932 3217832", login:"mad", password_digest: "abcdscascd", email: "mad@gmail.com" )
owner7 = Owner.create(name: "Shyla", phone_nbr: "672 3217832", login:"shy", password_digest: "abvfvscd", email: "shy@gmail.com" )
owner8 = Owner.create(name: "Persephone", phone_nbr: "432 3217832", login:"per", password_digest: "abvvfdsvcd", email: "per@gmail.com" )
owner9 = Owner.create(name: "Katrina", phone_nbr: "232 3217832", login:"kat", password_digest: "abvfdsvtrcd", email: "kat@gmail.com" )
